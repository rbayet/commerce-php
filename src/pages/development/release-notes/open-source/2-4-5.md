...
import Partner from 'src/_includes/release-notes/engcomm-2-4-5-partner.md'
...
import Issues from 'src/_includes/release-notes/engcomm-2-4-5-issues.md'
...
You can install Magento Open Source 2.4.5 using [Composer](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/composer).
