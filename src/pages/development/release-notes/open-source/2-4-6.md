...
*  Elasticsearch 8.x. See [Upgrade Elasticsearch](https://experienceleague.adobe.com/en/docs/commerce-operations/upgrade-guide/prepare/prerequisites#search-engine). <!-- AC-6597 -->
...
import Partner from 'src/_includes/release-notes/engcomm-2-4-6-partner.md'
...
import Issues from 'src/_includes/release-notes/engcomm-2-4-6-issues.md'
...
You can install Magento Open Source 2.4.6 using [Composer](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/composer).
